...
function showLoginModal(){
  ...
  overlay.innerHTML = `
    <div class="modal">
      ...
      <div class="small" style="margin-top:8px">Data disimpan lokal di browser.</div>
    </div>`;
...
function doLogin(){
  ...
  const users = loadUsers();
  if(!users[user] || users[user].pass !== pass){ alert('Login gagal (Username atau Password salah)'); return; }
...
function loginAs(user){ 
  ...
  // Tampilkan Profile Info & Tombol Logout
